...
describe('Email Consumer', () => {
    ...
    describe('authEmailMessageConsumer method', () => {
        it('should be called', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield (0, email_consumer_1.authEmailMessageConsumer)(connectionChannel);
    ...
    describe('orderEmailMessageConsumer method', () => {
        it('should be called', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            jest.spyOn(connection, 'createConnection').mockReturnValue(channel);
            const connectionChannel = yield connection.createConnection();
            yield (0, email_consumer_1.orderEmailMessageConsumer)(connectionChannel);
...
//# sourceMappingURL=email_consumer.test.js.map